...
contract ObjectTypeTest is DustTest {
  function testCategories() public pure {
...

    {
      ...
      assertFalse(ObjectTypes.WhiteGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.OrangeGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.MagentaGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.LightBlueGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.YellowGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.LimeGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.PinkGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.GrayGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.LightGrayGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.CyanGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.PurpleGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.BlueGlass.hasPickMultiplier(), "!hasPickMultiplier");
      assertFalse(ObjectTypes.BrownGlass.hasPickMultiplier(), "!hasPickMultiplier");
