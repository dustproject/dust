...
contract HitPlayerTest is DustTest {
  ...
  function testHitPlayerWithoutToolPartialDamage() public {
    ...
    uint128 aliceInitialEnergy = DEFAULT_HIT_ENERGY_COST * 10;
    uint128 bobInitialEnergy = DEFAULT_HIT_ENERGY_COST * 10;
    ...
    // Without tool: damage to Bob equals Alice's energy reduction (up to DEFAULT_HIT_ENERGY_COST)
    uint128 expectedAliceReduction = DEFAULT_HIT_ENERGY_COST;
  ...
  function testHitPlayerWithoutToolKillsTarget() public {
    ...
    uint128 aliceInitialEnergy = DEFAULT_HIT_ENERGY_COST * 2;
    uint128 bobInitialEnergy = DEFAULT_HIT_ENERGY_COST / 2; // Less than damage
    Energy.setEnergy(aliceEntityId, aliceInitialEnergy);
    Energy.setEnergy(bobEntityId, bobInitialEnergy);
  ...
  function testHitPlayerWithToolPartialDamage() public {
    ...
    uint128 aliceInitialEnergy = TOOL_HIT_ENERGY_COST + 1;
    Energy.setEnergy(aliceEntityId, aliceInitialEnergy);
    Energy.setEnergy(bobEntityId, bobInitialEnergy);
    ...
    uint128 expectedAliceReduction = TOOL_HIT_ENERGY_COST;
  ...
  function testHitPlayerWithToolKillsTarget() public {
    ...
    // Bob energy = TOOL_HIT_ENERGY_COST + half of what tool would normally reduce
    ...
    uint128 bobInitialEnergy = TOOL_HIT_ENERGY_COST + remainingEnergy;
    ...
    // Verify energy flowed to local pools
    uint128 aliceEnergyLost = assertEnergyFlowedFromPlayerToLocalPool(aliceSnapshot);
    assertEq(aliceEnergyLost, TOOL_HIT_ENERGY_COST, "Alice energy lost incorrect");
  ...
  function testHitPlayerWithoutToolAttackerDies() public {
    ...
    uint128 aliceInitialEnergy = DEFAULT_HIT_ENERGY_COST;
    uint128 bobInitialEnergy = DEFAULT_HIT_ENERGY_COST * 10;
    Energy.setEnergy(aliceEntityId, aliceInitialEnergy);
    Energy.setEnergy(bobEntityId, bobInitialEnergy);
  ...
  function testHitPlayerWithToolAttackerDies() public {
    ...
    uint128 aliceInitialEnergy = TOOL_HIT_ENERGY_COST;
    uint128 bobInitialEnergy = TOOL_HIT_ENERGY_COST * 10;
    Energy.setEnergy(aliceEntityId, aliceInitialEnergy);
    Energy.setEnergy(bobEntityId, bobInitialEnergy);
