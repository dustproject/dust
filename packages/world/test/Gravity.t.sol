...
import { MOVE_ENERGY_COST, PLAYER_FALL_ENERGY_COST, UNEQUIPPED_ACTION_ENERGY_COST } from "../src/Constants.sol";
...
contract GravityTest is DustTest {
  ...
  function testMineFallFatal() public {
    ...
    uint128 exactEnergy = UNEQUIPPED_ACTION_ENERGY_COST + 1;
    Energy.set(
    ...
    Vec3 mineCoord = playerCoord - vec3(0, 1, 0);
    ObjectType mineObjectType = TerrainLib.getBlockType(mineCoord);
    ObjectPhysics.setMass(mineObjectType, UNEQUIPPED_ACTION_ENERGY_COST);
    ...
    // Mining should use UNEQUIPPED_ACTION_ENERGY_COST, and falling should require PLAYER_FALL_ENERGY_COST,
  ...
  function testMineFallOnWater() public {
    ...
    uint128 initialEnergy = UNEQUIPPED_ACTION_ENERGY_COST + MOVE_ENERGY_COST + 1;
    Energy.set(
    ...
    assertEq(
      ...
      initialEnergy - UNEQUIPPED_ACTION_ENERGY_COST - MOVE_ENERGY_COST,
