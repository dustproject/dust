...
function initObjects() {
  ...
  ObjectTypeMetadata.set(ObjectTypes.DiamondBlock, ObjectTypeMetadataData({ mass: 5000000000000000000, energy: 0 }));
  ObjectTypeMetadata.set(ObjectTypes.NeptuniumBlock, ObjectTypeMetadataData({ mass: 5000000000000000000, energy: 0 }));
  ObjectTypeMetadata.set(ObjectTypes.WheatSeed, ObjectTypeMetadataData({ mass: 0, energy: 10000000000000000 }));
  ObjectTypeMetadata.set(ObjectTypes.OakSapling, ObjectTypeMetadataData({ mass: 0, energy: 100000000000000000 }));
  ObjectTypeMetadata.set(ObjectTypes.SpruceSapling, ObjectTypeMetadataData({ mass: 0, energy: 100000000000000000 }));
