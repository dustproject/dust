...
function initObjects() {
  ...
  ObjectTypeMetadata.set(ObjectTypes.OakSeed, ObjectTypeMetadataData({ mass: 0, energy: 100000000000000000 }));
  ObjectTypeMetadata.set(ObjectTypes.SpruceSeed, ObjectTypeMetadataData({ mass: 0, energy: 100000000000000000 }));
  ...
  ObjectTypeMetadata.set(ObjectTypes.Player, ObjectTypeMetadataData({ mass: 0, energy: MAX_PLAYER_ENERGY }));
  ObjectTypeMetadata.set(
    ObjectTypes.AnyLog, ObjectTypeMetadataData({ mass: 12500000000000000, energy: 5500000000000000 })
  );
  ObjectTypeMetadata.set(ObjectTypes.AnyPlank, ObjectTypeMetadataData({ mass: 4450000000000000, energy: 0 }));
  ObjectTypeMetadata.set(
