...
library ReversePlayerName {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "ReversePlayerNam", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000052657665727365506c617965724e616d);
   ...
   * @notice Get player.
   */
  function getPlayer(bytes32 name) internal view returns (address player) {
   ...
   * @notice Get player.
   */
  function _getPlayer(bytes32 name) internal view returns (address player) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
   ...
   * @notice Get player.
   */
  function get(bytes32 name) internal view returns (address player) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
   ...
   * @notice Get player.
   */
  function _get(bytes32 name) internal view returns (address player) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
   ...
   * @notice Set player.
   */
  function setPlayer(bytes32 name, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
   ...
   * @notice Set player.
   */
  function _setPlayer(bytes32 name, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
   ...
   * @notice Set player.
   */
  function set(bytes32 name, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
   ...
   * @notice Set player.
   */
  function _set(bytes32 name, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = name;
