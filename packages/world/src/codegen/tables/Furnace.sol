...
library Furnace {
   ...
   * @notice Get recipeId.
   */
  function getRecipeId(EntityId entityId) internal view returns (bytes32 recipeId) {
   ...
   * @notice Get recipeId.
   */
  function _getRecipeId(EntityId entityId) internal view returns (bytes32 recipeId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
   ...
   * @notice Set recipeId.
   */
  function setRecipeId(EntityId entityId, bytes32 recipeId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);

    StoreSwitch.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((recipeId)), _fieldLayout);
  }

  /**
   * @notice Set recipeId.
   */
  function _setRecipeId(EntityId entityId, bytes32 recipeId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);

    StoreCore.setStaticField(_tableId, _keyTuple, 0, abi.encodePacked((recipeId)), _fieldLayout);
  }
