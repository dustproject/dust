...
library ReverseFragmentPosition {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "ReverseFragmentP", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000052657665727365467261676d656e7450);
