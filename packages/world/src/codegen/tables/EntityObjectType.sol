...
library EntityObjectType {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "EntityObjectType", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000456e746974794f626a65637454797065);
