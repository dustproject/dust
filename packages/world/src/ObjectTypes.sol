...
library ObjectTypes {
  ...
  ObjectTypeId constant WetFarmland = ObjectTypeId.wrap(Block | 273);
  ObjectTypeId constant WheatSeed = ObjectTypeId.wrap(Block | 274);
  ObjectTypeId constant OakSeed = ObjectTypeId.wrap(Block | 275);
  ObjectTypeId constant SpruceSeed = ObjectTypeId.wrap(Block | 276);
