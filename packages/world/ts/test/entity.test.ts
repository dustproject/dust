...
describe("EntityId decoding", () => {
  ...
  it("decodePlayer", () => {
    ...
    ).toEqual("0x70997970C51812dc3A010C7d01b50e0d17dc79C8");
    expect(
      getPlayerAddress(
        "0x013c44cdddb6a900fa2b585dd299e03d12fa4293bc0000000000000000000000",
      ),
    ).toEqual("0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC");
    expect(
      getPlayerAddress(
        "0x0190f79bf6eb2c4f870365e785982e1f101e93b9060000000000000000000000",
      ),
    ).toEqual("0x90F79bf6EB2c4f870365E785982E1f101E93b906");
    expect(
      getPlayerAddress(
        "0x0115d34aaf54267db7d7c367839aaf71a00a2c6a650000000000000000000000",
      ),
    ).toEqual("0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65");
    expect(
      getPlayerAddress(
        "0x019965507d1a55bcc2695c58ba16fb37d819b0a4dc0000000000000000000000",
      ),
    ).toEqual("0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc");
    expect(
      getPlayerAddress(
        "0x01976ea74026e726554db657fa54763abd0c3a0aa90000000000000000000000",
      ),
    ).toEqual("0x976EA74026E726554dB657fA54763abd0C3a0aa9");
    expect(
      getPlayerAddress(
        "0x0114dc79964da2c08b23698b3d3cc7ca32193d99550000000000000000000000",
      ),
    ...
    ).toEqual("0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f");
    expect(
      getPlayerAddress(
        "0x01a0ee7a142d267c1f36714e4a8f75612f20a797200000000000000000000000",
      ),
    ).toEqual("0xa0Ee7A142d267C1f36714E4a8F75612F20a79720");
  });
});
