...
export const categories: { [key: string]: Category } = {
  ...
  Gemstone: { objects: ["Amethyst", "Glowstone"] },
  Soil: {
    objects: [
      "Grass",
      "Dirt",
  ...
  Sand: {
    objects: ["Gravel", "Sand", "RedSand", "Sandstone", "RedSandstone", "Clay"],
  },
  Terracotta: {
    objects: [
      "AnyTerracotta",
  ...
  Greenery: {
    objects: ["FescueGrass", "SwitchGrass", "VinesBush", "IvyVine", "HempBush"],
  },
  Crop: {
    objects: [
      "GoldenMushroom",
  ...
  MiscBlock: {
    objects: ["Snow", "Ice", "Magma", "SpiderWeb", "Bone", "TextSign"],
  },
  ...
  SmartEntityBlock: {
    objects: ["ForceField", "Chest", "SpawnTile", "Bed"],
  },
  Station: {
