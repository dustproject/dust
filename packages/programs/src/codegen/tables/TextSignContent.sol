...
library TextSignContent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "defaultprogram", name: "TextSignContent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656661756c7470726f6772616d546578745369676e436f6e74656e7400);
