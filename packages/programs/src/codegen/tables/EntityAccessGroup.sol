...
library EntityAccessGroup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "defaultprogram", name: "EntityAccessGrou", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656661756c7470726f6772616d456e7469747941636365737347726f75);
