...
library AccessGroupMember {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "defaultprogram", name: "AccessGroupMembe", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746264656661756c7470726f6772616d41636365737347726f75704d656d6265);
